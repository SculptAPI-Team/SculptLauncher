...
public class XLECheckBox extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.checkBox.measure(MeasureSpec.makeMeasureSpec(Math.max((size - paddingLeft) - getPaddingRight(), 0), i4), MeasureSpec.makeMeasureSpec(Math.max(i5 - getPaddingBottom(), 0), i3));
        int measuredWidth = paddingLeft + this.checkBox.getMeasuredWidth();
        int i6 = size - measuredWidth;
        this.text.measure(MeasureSpec.makeMeasureSpec(Math.max(i6 - getPaddingRight(), 0), i4), MeasureSpec.makeMeasureSpec(Math.max(i5 - getPaddingBottom(), 0), i3));
        int max = paddingTop + Math.max(this.checkBox.getMeasuredHeight(), this.text.getMeasuredHeight());
        this.subText.measure(MeasureSpec.makeMeasureSpec(Math.max(i6 - getPaddingRight(), 0), i4), MeasureSpec.makeMeasureSpec(Math.max((size2 - max) - getPaddingBottom(), 0), i3));
